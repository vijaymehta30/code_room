...
const Home = () => {
  ...
  <div className="fixed top-0 left-0 right-0 bottom-0 w-screen h-screen bg-[rgb(0,0,0,0.2)] flex items-center justify-center">

    {/* First Popup */}
    {activePopup === "" &&

      <div className="w-[25vw] bg-[#141414] rounded-[20px] p-[30px] shadow-lg shadow-black/50">
        ...
        <div className='flex flex-col gap-4'>
          ...
          <button
           onClick={() => navigate("/group")} 
            className='bg-[#202020] hover:bg-[#2a2a2a] text-white py-3 rounded-lg'
          >
            Create Room
          </button>
    ...
    {/* Second Popup - Create Project */}
    {activePopup === "project" &&

      <div className="w-[25vw] bg-[#141414] rounded-[20px] p-[40px] shadow-lg shadow-black/50">
        ...
        <div className='flex items-center gap-[10px] w-full mt-5'>

          <button
            onClick={createProj}
            className='btnBlue rounded-[5px] w-[49%] !py-[10px]'
          >
            Create
          </button>
          ...
          <button
            ...
            className='bg-[#202020] hover:bg-[#2a2a2a] rounded-[5px] w-[49%] py-[10px] text-white'
          >
            Back
          </button>
