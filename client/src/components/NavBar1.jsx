...
const NavBar1 =({ isGridLayout, setIsGridLayout })=>{
        ...
        <>
            <div className="navbar flex items-center justify-between px-[100px]     h-[80px] bg-[#141414]">
                ...
                <div className="links flex items-center gap-5">
                    ...
                    <Avatar onClick={() => { toggleClass(".dropDownNavbar", "hidden") }} name={data ? data.name : ""} size="40" round="50%" className=' cursor-pointer ml-2' />
                         ...
                         <div className='dropDownNavbar hidden absolute right-[60px] top-[80px] shadow-lg shadow-black/50 p-[10px] rounded-lg bg-[#1A1919] w-[150px] h-[160px]'>
                                  <div className='py-[10px] border-b-[1px] border-b-[#fff]'>
                                    ...
                                    <h3 className='flex items-center gap-2 mt-3 mb-2 cursor-pointer' style={{ fontStyle: "normal" }}>Profile</h3>
                    ...
                    <button className="flex items-center justify-center gap-[10px] w-[91px] h-[36px] rounded-[8px] bg-[#4079da] text-white text-[14px] font-bold px-[10px] whitespace-nowrap border-none shrink-0 cursor-pointer" onClick={()=>navigate('/homep')}>
                    Login
                        </button>
                   <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200" onClick={()=>navigate('/homep')}>
                     SignUp
                    </button>
                </div>
            </div>
